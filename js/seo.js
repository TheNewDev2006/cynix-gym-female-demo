(function() {
    ...
    function getHeroImage() {
        ...
        const heroImages = {
            'index.html': 'images/background/2.webp',
            'about.html': 'images/background/5.webp',
            'classes.html': 'images/background/8.webp',
            'class-single.html': 'images/background/5.webp',
            'schedule.html': 'images/background/7.webp',
            'pricing.html': 'images/background/3.webp',
            'contact.html': 'images/background/6.webp',
            'join.html': 'images/background/6.webp',
            'team.html': 'images/background/5.webp',
            'blog.html': 'images/background/2.webp',
            'blog-single.html': 'images/background/5.webp'
        };
        return heroImages[page] || 'images/background/2.webp';
    }
