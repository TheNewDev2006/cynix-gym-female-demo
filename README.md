# Cynix Female Gym Demo Website

Professional female-focused gym website template for Cynix Inc cold outreach.
...
2. **Add Custom Domain**
   ...
   - Add subdomain: `{gymname}.cynixinc.dev`
...
```
https://your-demo-url.vercel.app?name=Pink%20Fitness&phone=0712345678&address=Colombo%2005&owner=Sarah
```

| Parameter | Description | Example |
|-----------|-------------|---------|
| `name` | Gym Business Name | Pink Fitness |
